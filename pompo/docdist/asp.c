...
void asp(int size, cost **Array, long *col_mate, long *row_mate)
{
  ...
  t= 0;
  for(l= 0;l<n;l++){
    row_mate[l] = parent_row[l]= -1;
    //col_inc[l]= 0; //BL: useless
    slack[l]= INF;
  }
  for(k= 0;k<m;k++){
    s= Array[k][0];
